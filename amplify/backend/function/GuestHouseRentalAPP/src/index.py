...
def handle_post_request(event):
    ...
    try:
        ...
        # Construct SQL query
        sql_query = f"""INSERT INTO tblHouses (houseId, houseHeading, numberOfBedroom, numberOfBathroom, numberOfBalcony, 
                        dateOfPosting, isActive, houseDescription, houseNumber, houseFloorNumber, housePaymentType, locationId, 
                        isVerified, price, ownerId, lastModified, area, houseType, latitude, longitude, houseStatus) 
